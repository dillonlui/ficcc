...
npm run build && test -f dist/client/zh/ministries/index.html && grep -q '團契' dist/client/zh/ministries/index.html && grep -q 'lang="zh"' dist/client/zh/ministries/index.html && ! grep -q '團契' dist/client/ministries/index.html
